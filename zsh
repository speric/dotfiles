...
alias fresh="be rake chargify:reset && bundle install && (cd frontend && yarn install)"
...
alias update="git pull && bundle && be rake db:migrate db:test:prepare && (cd frontend && yarn install)"
